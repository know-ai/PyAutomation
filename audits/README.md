...
| **14 Calidad OPC + arranque degradado** | [AUDIT_OPC_QUALITY_AND_DEGRADED_STARTUP.md](./AUDIT_OPC_QUALITY_AND_DEGRADED_STARTUP.md) | (nuevo 2026-08-20) | **B− operativo** / **D calidad de señal** — StatusCode no mapeado; OPC/BD offline no bloquean; Login 503+form; gaps hold/inhibit/stale |
