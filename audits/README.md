...
| **15 Catálogo local SQLite** | [AUDIT_CATALOG_SQLITE_LOCAL.md](./AUDIT_CATALOG_SQLITE_LOCAL.md) | Spec [11](../specs/11-CATALOG-SQLITE-LOCAL.md) — verificación 2026-08-21 P0 | **A autonomía + integridad reinicio (código)** / **A separación SAF** / **A HMI-API** / **A− sync planta** — CA-01…06/10…13/15…18 PASS; soak 07–09/14 + CA planta P0 pendiente |
