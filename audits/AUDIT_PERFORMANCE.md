# Auditoría: Rendimiento, memoria y dashboard del nodo

| Campo | Valor |
|---|---|
| **Producto** | PyAutomationIO (`automation/` + HMI `hmi/src/`) |
| **Documento canónico** | 05 / 10 |
| **Fecha de agrupación** | 2026-09-16 |
| **Fuentes absorbidas** | `AUDIT_PERFORMANCE`, `AUDIT_BACKEND_PERFORMANCE`, `AUDIT_MEMORY`, `PERFORMANCE_RUNBOOK`, `AUDIT_NODE_PERFORMANCE_DASHBOARD` |
| **Complementa** | [AUDIT_DB.md](./AUDIT_DB.md), [AUDIT_HMI.md](./AUDIT_HMI.md), [AUDIT_RELIABILITY.md](./AUDIT_RELIABILITY.md), [AUDIT_ALARMS.md](./AUDIT_ALARMS.md), [AUDIT_MULTI_EDGE.md](./AUDIT_MULTI_EDGE.md) |
| **Veredicto vigente** | Hot path **A−**; observers cerrados; soak 24 h pendiente. Dashboard **A−** (snapshot O(1), `ALM.PERF.*`); soak 24 h / 2-edge / HMI planta pendientes |
...
- [Parte A — Rendimiento backend, memoria y runbook 24/7](#parte-a-rendimiento-backend-memoria-y-runbook-247)
- [Parte B — Dashboard de performance del nodo y alarmas ALM.PERF](#parte-b-dashboard-de-performance-del-nodo-y-alarmas-almperf)

---

## Parte A — Rendimiento backend, memoria y runbook 24/7

> Fuente original: `AUDIT_PERFORMANCE.md` — contenido íntegro, sin omisiones.
...
| **Complementa** | [AUDIT_DB.md](./AUDIT_DB.md) (BE-H4, sockets), [AUDIT_DB.md](./AUDIT_DB.md), [AUDIT_HMI.md](./AUDIT_HMI.md), [AUDIT_RELIABILITY.md](./AUDIT_RELIABILITY.md), [AUDIT_ALARMS.md](./AUDIT_ALARMS.md) (cola de transiciones O(1)) |
...
P2 2026-09-16: lookup `is_suppressed` O(1) en HOT. T-179 p99=**24.6 µs**. KPI/archive/suppression fuera del DAS. Ver [AUDIT_ALARMS.md](./AUDIT_ALARMS.md).
...
| `LOG_ERROR_RATE_PER_MIN` | **> 5** | [AUDIT_RELIABILITY.md](./AUDIT_RELIABILITY.md) |
...
#### 4.5 Logs, stdout, retención (extracto; detalle [AUDIT_RELIABILITY.md](./AUDIT_RELIABILITY.md))
...
`AUTOMATION_TIMEZONE` = presentación. Storage UTC. Detalle: [AUDIT_TIME.md](./AUDIT_TIME.md).
...
## Parte B — Dashboard de performance del nodo y alarmas ALM.PERF

> Fuente original: `AUDIT_NODE_PERFORMANCE_DASHBOARD.md` — contenido íntegro, sin omisiones.
...
| **Complementa** | [AUDIT_PERFORMANCE.md](./AUDIT_PERFORMANCE.md), [AUDIT_DB.md](./AUDIT_DB.md), [AUDIT_HMI.md](./AUDIT_HMI.md), [AUDIT_DB.md](./AUDIT_DB.md), [AUDIT_RELIABILITY.md](./AUDIT_RELIABILITY.md), [AUDIT_MULTI_EDGE.md](./AUDIT_MULTI_EDGE.md) |
...
| CA-ISOLATION-05 | Txn/min reposo &lt; 50 con errores de integridad persistentes | **Pendiente** soak 1 h planta; ver [AUDIT_DB.md](./AUDIT_DB.md) §3.4 |
...
| 2026-09-15 | SAF nuclear: `saf/retry` resucita `DEAD_LETTER` (no es reset); histéresis DLQ; badge `condition_met` en Alarmas; `GET /api/health/ready` 200 DEGRADED. Contrato: [AUDIT_DB.md](./AUDIT_DB.md) §3.5 |
