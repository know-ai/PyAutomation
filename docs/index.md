...
<div style="text-align: center; margin: 2em 0;">
  ...
  <p style="font-size: 1.3em; color: #64748b; margin-top: 0;">
    Empowering Industry 4.0 with Python, React, and Open Standards
  </p>
</div>

![PyAutomation 2.0.0 Dashboard](Users_Guide/images/FirstPageAfterLogin.png)
...
![PyAutomation Architecture Overview](Users_Guide/images/Sidebar.png)
...
![Monitoring System](Users_Guide/images/TagsCreated.png)
...
![Real-Time Trends](Users_Guide/images/RealTimeStripChartIntoProductionMode.png)
...
![Alarm Management](Users_Guide/images/AlarmsDashboard_WithAlarms.png)
...
![Data Logging](Users_Guide/images/DataLoggerFilterSample5Sec.png)
...
![User Management](Users_Guide/images/UserManagementPage.png)
...
<div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 50%, #4facfe 100%); border-radius: 15px; padding: 3em; margin: 3em 0; box-shadow: 0 20px 60px rgba(0,0,0,0.3); text-align: center; color: white;">
...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; padding: 2.5em; margin: 2em 0; color: white;">

<h3 style="color: white; font-size: 1.8em; margin-bottom: 1em;">
  💎 Enterprise-Grade Features. Zero Cost. Open Source.
</h3>

<p style="font-size: 1.3em; line-height: 1.8; margin-bottom: 1.5em;">
...
<p style="font-size: 1.1em; line-height: 1.8; color: #4a5568;">
...
<p style="font-size: 1.1em; line-height: 1.8; color: #4a5568; margin-top: 1em;">
  <strong>You get the same power. You get the same reliability. You get the same features.</strong>
</p>

<p style="font-size: 1.3em; line-height: 1.8; color: #667eea; margin-top: 1.5em; font-weight: bold;">
...
<div style="background: white; border: 2px solid #667eea; border-radius: 10px; padding: 1.5em; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
...
<div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 15px; padding: 2.5em; margin: 3em 0; text-align: center; color: white; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
...
<p style="font-size: 1.4em; line-height: 1.8; margin-bottom: 1em; font-weight: 300;">
  Not just for companies with million-dollar budgets.
</p>

<p style="font-size: 1.4em; line-height: 1.8; margin-top: 1.5em; font-weight: bold;">
  PyAutomation proves that <strong>world-class industrial automation</strong> can be <strong>free, open, and powerful</strong>.
</p>

<p style="font-size: 1.6em; line-height: 1.8; margin-top: 1.5em; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">
...
<div style="text-align: center; margin: 3em 0; padding: 2em; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; color: white;">
