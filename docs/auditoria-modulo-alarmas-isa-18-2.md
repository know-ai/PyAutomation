...
> **2026-09-16 — documento no canónico.** El informe vigente está en [`audits/AUDIT_ALARMS.md`](../audits/AUDIT_ALARMS.md) (P0/P1 + O(1) hot path v2). Este archivo (2026-06-20) se conserva como contexto.
