...
Repeated ERROR records are rate-limited by <code>DedupeFilter</code> (<code>log_error_cooldown_seconds</code>, default 60). The decorator does not <code>print</code>; stdout follows <code>log_level</code> when <code>AUTOMATION_LOG_TO_STDOUT=1</code>. Health exposes <code>LOG_ERROR_RATE_PER_MIN</code>. HTTP/Socket access audit: <code>audits/AUDIT_RELIABILITY.md</code> §8 (backlog LOG-ACC-1).
</p>
