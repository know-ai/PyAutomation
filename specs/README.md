...
| **03** | [03-NTP-EDGE-CLOCK-MONITOR.md](./03-NTP-EDGE-CLOCK-MONITOR.md) | Monitor SNTP edge, alarmas, HMI — **implementado v1.0** ([AUDIT_TIME](../audits/AUDIT_TIME.md)) |
| **04** | [04-HMI-SOCKET-TRACEABILITY.md](./04-HMI-SOCKET-TRACEABILITY.md) | Sesiones HMI en PG, fail-closed, TLS/IP — **implementado** ([AUDIT_HMI](../audits/AUDIT_HMI.md)) |
| **05** | [05-NODE-PERFORMANCE-DASHBOARD.md](./05-NODE-PERFORMANCE-DASHBOARD.md) | Dashboard de rendimiento del nodo O(1) — **implementado P0+P1** ([AUDIT_PERFORMANCE](../audits/AUDIT_PERFORMANCE.md)) |
| **06** | [06-PERFORMANCE-ALARMS.md](./06-PERFORMANCE-ALARMS.md) | Alarmas ISA-18.2 de rendimiento; dashboard + Alarmas + Settings — **implementado** ([AUDIT_PERFORMANCE](../audits/AUDIT_PERFORMANCE.md)) |
...
| **08** | [08-WAVELET-RPA-RT.md](./08-WAVELET-RPA-RT.md) | Filtro wavelet DWT por bloques, tag `.f`, calidad OPC en pipeline — **implementado** ([AUDIT_TAGS](../audits/AUDIT_TAGS.md)) |
