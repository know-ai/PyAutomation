...
| **11** | [11-CATALOG-SQLITE-LOCAL.md](./11-CATALOG-SQLITE-LOCAL.md) | Catálogo local SQLite espejo + sync bidireccional con PG/MySQL; multi-edge; sin SQLite en HMI central — **implementado v1.3** (soak pendiente) · [auditoría](../audits/AUDIT_CATALOG_SQLITE_LOCAL.md) · [docs](../docs/catalog-sqlite.md) |
