...
_DEFAULTS: dict[str, Any] = {
    ...
    "perf_saf_deadletter_clear_threshold": 0.0,
...
_ENV_MAP = {
    ...
    "AUTOMATION_PERF_SAF_DEADLETTER_CLEAR_THRESHOLD": ("perf_saf_deadletter_clear_threshold", float),
...
_CLAMP: dict[str, tuple[float, float]] = {
    ...
    "perf_saf_deadletter_clear_threshold": (0, 10_000_000),
